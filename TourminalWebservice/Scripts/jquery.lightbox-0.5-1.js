    ...
    */
    $.fn.lightBox = function (settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading: 'http://photocdn.spain-holiday.com/pics-uk/lightbox-ico-loading.gif', 	// (string) Path and the name of the loading icon
            imageBtnPrev: 'http://photocdn.spain-holiday.com/pics-uk/lightbox-btn-prev_new.gif', 		// (string) Path and the name of the prev button image
            imageBtnNext: 'http://photocdn.spain-holiday.com/pics-uk/lightbox-btn-next_new.gif', 		// (string) Path and the name of the next button image
            imageBtnClose: 'http://photocdn.spain-holiday.com/pics-uk/lightbox-btn-close_new.gif', 	// (string) Path and the name of the close btn
            imageBlank: 'http://photocdn.spain-holiday.com/pics-uk/lightbox-blank.gif', 		// (string) Path and the name of a blank image (one pixel)
        ...
        */
        function _set_interface() {
            ...
            $('#lightbox-slideshow').click(function () {
                ...
                if (settings.slideshow) {
                    var tmFunc = function () { _doSlideShow(); };
                    setTimeout(tmFunc, settings.nextSlideDelay);
                    $('#lightbox-slideshow').text(slideshowStopText);
                }
                else {
                    $('#lightbox-slideshow').text(slideshowStartText);
                }
                return false;
            });
