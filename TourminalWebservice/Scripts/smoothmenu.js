...
var ddsmoothmenu = {
    ...
    //arrowimages: { down: ['downarrowclass', '../../Content/Images/arrowsm.png', 25], right: ['rightarrowclass', '../../Content/Images/right.gif'] },
    arrowimages: { down: ['downarrowclass', '../../Content/Images/arrowsm.png', 25], right: ['rightarrowclass', '../../Content/Images/right.gif'] },
    ...
    buildmenu: function ($, setting) {
        ...
        $headers.each(function (i) { //loop through each LI header
			...
			(this.istopheader ? '<img src="' + smoothmenu.arrowimages.down[1] + '" class="' + smoothmenu.arrowimages.down[0] 
            + '" style="border:0;" />' : '')
		)
