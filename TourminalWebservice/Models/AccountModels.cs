...
namespace TourminalWebservice.Models {
    ...
    public class AccountMembershipService : IMembershipService {
        ...
        public bool ValidateUser (string userName, string password) {
            if (String.IsNullOrEmpty(userName))
                throw new ArgumentException("Значение не может быть равно NULL или быть пустым.", "userName");
        ...
        public bool ChangePassword (string userName, string oldPassword, string newPassword) {
            ...
            if (String.IsNullOrEmpty(oldPassword))
                throw new ArgumentException("Значение не может быть неопределенным (null) или пустым.", "oldPassword");
            if (String.IsNullOrEmpty(newPassword))
                throw new ArgumentException("Значение не может быть неопределенным (null) или пустым.", "newPassword");
