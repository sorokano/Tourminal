...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="../../Admin/Index">Главное меню</a> > <a href="../../Admin/CruiseList">Список круизов</a> > <a href="../../Admin/CruiseEdit?id=<%= ViewData["TourId"] %>">Редактировать круиз <%= ViewData["TourName"]%></a>
    <br />
    <table>
        ...
        <tr valign="top">
            <td style="width: 450px;">
                <div style="width: 300px;">
                    <fieldset>
                        <h2>Загрузить картинку (175пикс на 160пикс)</h2>
