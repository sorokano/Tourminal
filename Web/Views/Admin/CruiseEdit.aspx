...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#btncancel").click(function (e) {
                location.href = '../../Admin/CruiseList';
            });
        });
    </script>
    <a href="../../Admin/Index">Главное меню</a> > <a href="../../Admin/CruiseList">Вернуться к списку круизов</a>
    <br /><br />
    ...
    <% using (Html.BeginForm("CruiseEdit", "Admin", FormMethod.Post)) { %>
    <input type="text" visible="false" style="display: none;" id="txtId" name="txtId" value="<%= ViewData["TourId"] %>" />
    <table>
        <tr>
            <td colspan="3">
                <table><tr><td><span style="color:red">*</span> Название</td><td><%= Html.TextBox("txtName", ViewData["TourName"], new { style = "width:500px" })%></tr></td></table>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <table><td><span style="color:red">*</span> Цена</td><td><%= Html.TextBox("txtPrice", ViewData["TourPrice"] != null ? ViewData["TourPrice"].ToString() : string.Empty
                                                                                                , new { style = "width:500px" })%></td></table>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <table><td>Кол-во дней:</td><td><%= Html.TextBox("txtTourDays", ViewData["TourDays"] != null ? ViewData["TourDays"].ToString() : string.Empty
                                                                                                , new { style = "width:500px" })%></td></table>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <table><td>Популярность:</td><td><%= Html.TextBox("txtTourPopularity", ViewData["TourPopularity"] != null ? ViewData["TourPopularity"].ToString() : string.Empty
                                                                                                , new { style = "width:500px" })%></td></table>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                <table><td>СПЕЦПРЕДЛОЖЕНИЕ:</td><td><%= Html.CheckBox("chkIsSpecialOffer", bool.Parse(ViewData["TourIsSpecialOffer"].ToString()))%></td></table>
            </td>
        </tr>
        <tr>
            <td colspan="3">
    ...
    <div style="position: relative; float: right; width: 400px; height: 110px; margin-top: -100px;" id="divPhotoArea">
        ...
        <% } %>
        <br />
        <a href="/Admin/EditCruisePhoto?id=<%= ViewData["TourId"].ToString() %>">Редактировать фото</a>
    </div>
    Описание маршрута:
    <br />
