...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.getJSON('http://tourminal.ru/ElcondorWCF.svc/GetTourTypeListJS?method=?&', function (response) {
                var result = "";
    ...
    <a href="../../Admin/Index">Главное меню</a> > <a href="../../Admin/TourList">Вернуться к списку туров</a>
    <h2>Добавление нового маршрута</h2>
    <%= Html.ValidationSummary("Не удалось сохранить. Проверьте данные и попробуйте снова.") %>
    <% using (Html.BeginForm("AddTour", "Admin", FormMethod.Post)) { %>
    <table>
        <tr>
            <td>
            ...
            <td>
                <span class="spanDistrict">
                    <table>
                        ...
                        <tr>
                            <td>
                                <%--<%= Html.DropDownList("ddlDistrict", (IEnumerable<SelectListItem>)ViewData["ddlDistrict"])%> --%>
                                  <div class="holder">
        ...
        <tr>
            <td colspan="3">
                <table><td><span style="color:red">*</span> Название</td><td><%= Html.TextBox("txtTourName", ViewData["Name"], new { style = "width:500px" })%></td></table>
            </td>
        </tr>
    </table>
    <div style="position: relative; float: right; width: 400px; height: 110px; margin-top: -100px;color:#333333;" id="divPhotoAreaNotice">
        Фотографию можно добавлять только после создания Тура (кнопка "Добавить Тур").
    </div>
    <div style="position: relative; float: right; width: 400px; height: 110px; margin-top: -100px;color:#333333;" id="div1">
        Отметить Тур как "Готовый тур" и "Спецпредложение" можно после создания Тура (кнопка "Добавить Тур").
    </div>
    Содержание статьи:
    <br />
