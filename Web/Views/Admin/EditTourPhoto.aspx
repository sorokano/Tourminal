...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Редактирование фото маршрута: "<%= ViewData["TourName"] + "\", " + ViewData["RegionName"] + " (" + ViewData["CountryName"] + ")" %>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="../../Admin/Index">Главное меню</a> > <a href="../../Admin/TourList">Список туров</a> > <a href="../../Admin/TourEdit?id=<%= ViewData["TourId"] %>">Редактировать маршрут <%= ViewData["TourName"]%></a>
    <br />
    <table>
    <h2>Редактирование фото тура: "<%= ViewData["TourName"] + "\", " + ViewData["RegionName"] + " (" + ViewData["CountryName"] + ")" %></h2>
    <table>
        <tr valign="top">
