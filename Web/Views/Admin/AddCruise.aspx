...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.getJSON('http://tourminal.ru/ElcondorWCF.svc/GetCruiseTypeListJS?method=?&', function (response) {
                var result = "";
    ...
    <h2>Добавление нового круиза</h2>
    <%= Html.ValidationSummary("Не удалось сохранить. Проверьте данные и попробуйте снова.") %>
    <% using (Html.BeginForm("AddCruise", "Admin", FormMethod.Post)) { %>
    <table>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="3">
                <table><td><span style="color:red">*</span> Название</td><td><%= Html.TextBox("txtCruiseName", ViewData["Name"], new { style = "width:500px" })%></td></table>
            </td>
        </tr>
    </table>
    <div style="position: relative; float: right; width: 400px; height: 110px; margin-top: -100px;color:#333333;" id="divPhotoAreaNotice">
        Фотографию можно добавлять только после создания круиза (кнопка "Добавить круиз").
    </div>
    Содержание статьи:
    <br />
    <%= Html.TextArea("content", ViewData["Description"] == null ? string.Empty : ViewData["Description"].ToString(), 3, 1, new { name = "content" })%>
    <p>
        <input type="submit" value="Добавить круиз" />
