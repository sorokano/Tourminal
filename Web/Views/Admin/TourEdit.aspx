...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Редактирование маршрута "<%= ViewData["TourName"] + "\", " + ViewData["TourRegionNames"] + " (" + ViewData["CountryName"] + ")"%>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="../../Admin/TourList">Вернуться к списку туров</a>
    <br /><br />
    <h2>Редактирование маршрута "<%= ViewData["TourName"] + "\", " + ViewData["TourRegionNames"] + " (" + ViewData["CountryName"] + ")"%></h2>
    <%= Html.ValidationSummary("Не удалось сохранить. Проверьте данные и попробуйте снова.") %>

    <% using (Html.BeginForm("TourEdit", "Admin", FormMethod.Post)) { %>
    ...
    <table>
        ...
        <tr>
            <td colspan="3">
                <table><tr><td>ГОТОВЫЙ ТУР:</td><td><%= Html.CheckBox("chkIsReadyTour", Boolean.Parse(ViewData["IsReadyTour"].ToString()))%></td></tr></table>
            </td>
        </tr>  
        <tr>
            <td colspan="3">
    ...
    <div style="position: relative; float: right; width: 400px; height: 110px; margin-top: -100px;" id="divPhotoArea">
        ...
        <% } %>
        <br />
        <a href="/Admin/EditTourPhoto?id=<%= ViewData["TourId"].ToString() %>">Редактировать фото</a>
    </div>
    Описание маршрута:
    <br />
